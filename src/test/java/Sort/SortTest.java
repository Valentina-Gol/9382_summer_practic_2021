...
public class SortTest {
    protected final int[] testArr1 = new int[0];
    protected final int[] testArr2 = new int[] {10, 100, 0, 34, 45, 20, 1, 90, 34, 56};
    protected final int[] testArr3 = new int[] {80, 49, 94, 56, 44, 93, 68, 90, 58, 28, 65,
    ...
    protected final int[] resArr1 = new int[0];
    protected final int[] resAsArr2 = new int[] { 0, 1,10, 20, 34, 34, 45, 56, 90, 100};
    protected final int[] resDesArr2 = new int[] { 100, 90, 56, 45, 34, 34, 20,10, 1, 0};
    protected final int[] resAsArr3 = new int[] { 1, 2, 3, 3, 3, 8, 10, 10, 10, 13, 15, 15,
                ...
                36, 42, 43, 44, 44, 45, 45, 47, 47, 49, 49, 52, 54, 54, 54, 55, 55, 56, 56, 57,
                    57, 57, 58, 59, 59, 60, 60, 62, 63, 63, 65, 67, 68, 68, 68, 68, 69, 70, 70, 73, 73,
                        73, 73, 75, 78,80, 80, 82, 84, 84, 85, 85, 85, 89, 89, 89, 90, 91, 91, 91, 93, 93, 94,
                            96, 97, 97, 98, 100, 100};
    protected final int[] resDesArr3 = new int[] { 100, 100, 98, 97, 97, 96, 94, 93, 93, 91,
